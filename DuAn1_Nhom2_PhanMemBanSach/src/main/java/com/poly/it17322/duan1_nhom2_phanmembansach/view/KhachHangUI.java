...
public class KhachHangUI extends javax.swing.JPanel {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        for (KhachHang i : khachHangService.getList()) {
    ...
    private void tblKHMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblKHMouseClicked
        try {
            ...
            KhachHang kh = khachHangService.getList().get(index);
            showDetail(kh);
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//    }
    ...
    private KhachHang getFormData() {
        ...
        KhachHang kh = new KhachHang(null, ma, ten, null, sdt, gioiTinh, null, null, null);
        return kh;
